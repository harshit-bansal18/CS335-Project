...
0000000000401020 <_Znwm@plt-0x10>:
  401020:	ff 35 e2 2f 00 00    	push   0x2fe2(%rip)        # 404008 <_GLOBAL_OFFSET_TABLE_+0x8>
  401026:	ff 25 e4 2f 00 00    	jmp    *0x2fe4(%rip)        # 404010 <_GLOBAL_OFFSET_TABLE_+0x10>
  40102c:	0f 1f 40 00          	nopl   0x0(%rax)

0000000000401030 <_Znwm@plt>:
  401030:	ff 25 e2 2f 00 00    	jmp    *0x2fe2(%rip)        # 404018 <_Znwm@GLIBCXX_3.4>
...
0000000000401126 <main>:
  ...
  40112e:	bf 08 00 00 00       	mov    $0x8,%edi
  401133:	e8 f8 fe ff ff       	call   401030 <_Znwm@plt>
  401138:	c7 00 00 00 00 00    	movl   $0x0,(%rax)
  40113e:	c6 40 04 00          	movb   $0x0,0x4(%rax)
  401142:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
  401146:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  40114a:	c7 00 17 00 00 00    	movl   $0x17,(%rax)
  401150:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  401154:	c6 40 04 61          	movb   $0x61,0x4(%rax)
